...
import EducationalPlaylogs from '~/pages/solutions/educational-playlogs'

import Meta from '~/mixins/meta'

describe('pages/solutions/educational-playlogs', () => {
  const wrapper = mount(EducationalPlaylogs, {
    mocks: {
      $t: text => text,
      $i18n: { locale: 'en' },
