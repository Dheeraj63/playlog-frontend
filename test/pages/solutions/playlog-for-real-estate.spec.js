...
import PlaylogForRealEstate from '~/pages/solutions/playlog-for-real-estate'

import Meta from '~/mixins/meta'

describe('pages/solutions/playlog-for-real-estate', () => {
  const wrapper = mount(PlaylogForRealEstate, {
    mocks: {
      $t: text => text,
      $i18n: { locale: 'en' },
